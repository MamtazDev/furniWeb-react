  ...
  <div className="container">
    <div className="seller_area">
      ...
      <div className="row g-4">
        <div className="col-md-6 col-lg-4" data-aos="fade-right" data-aos-offset={200}  data-aos-duration={300} data-aos-easing="ease-in-out" data-aos-once="false">
        ...
        <div className="col-md-6 col-lg-4" data-aos="fade-up" data-aos-offset={200}  data-aos-duration={300} data-aos-easing="ease-in-out" data-aos-once="false">
        ...
        <div className="col-md-6 col-lg-4" data-aos="fade-left" data-aos-offset={200}  data-aos-duration={300} data-aos-easing="ease-in-out" data-aos-once="false">
